...
void Board::shuffleBoard()
{
	...
	map<DevCards, int> devs = { {KNIGHT,14},{ROAD_BUILDING,2},{MONOPOLY,2},{YEARS_OF_PLENTY,2},{VICTORY_POINTS,5} }; // cambie las cantidades
	...
	for (int i = 0; i < 19; i++) // sorteo los recursos // poner en i = 0!!
	{
...
void Board::copyBoard(Board * original)
{
	...
	{
		aux2 = new Sea;
		aux2->setPortType(original->getPortType(i+'0'));
		board[i + '0'] = aux2;
	}
