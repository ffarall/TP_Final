...
enum MainTypes : EventTypes { NETWORK, PLAY_AGAIN_MT, GAME_OVER, START_GAME, PLAYER_ACTION, QUIT_MT, TICKS, LOCAL_STARTS, REMOTE_START, TURN_FINISHED, I_WON, TIME_OUT_MT, ERR_IN_COM };
